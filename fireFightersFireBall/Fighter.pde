  ...
  void quickAttackHitbox(){
    ...
    fill(0,0,100);
     ...
     if(playerNumber == 1 && Block != true && player1.location.y == 800 && player2.Block == false){
      rect(location.x+qAWidth/2+fighterWidth/2,location.y,qAWidth,qAHeight);
    ...
    if(playerNumber == 2 && Block != true && player2.location.y == 800 && player1.Block == false){
      rect(location.x-qAWidth/2-fighterWidth/2,location.y,qAWidth,qAHeight);
      if((location.x-qAWidth-fighterWidth<player1.location.x)&&(location.y-qAHeight/2-fighterHeight/2<player1.location.y)){
        println("p1 hit");
